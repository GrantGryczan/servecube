...
* Babel has a few limitations which may, depending on your code, require some extra polyfills. See [https://babeljs.io/docs/usage/caveats/](this page) for information on that. To cover these limitations, I recommend using [`core-js`](https://cdnjs.cloudflare.com/ajax/libs/core-js/2.5.7/core.min.js), a general ES5+ browser polyfill, and [`regenerator`](https://cdn.jsdelivr.net/npm/regenerator-runtime@latest/runtime.min.js), a dependency of Babel's accommodation for generators and async functions.
